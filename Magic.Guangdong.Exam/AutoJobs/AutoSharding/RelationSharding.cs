    ...
    public class RelationSharding : IInvocable
    {
        ...
        {            
            try
            {
                ...
                {
                    Assistant.Logger.Warning("考试系统数据库（magic.guangdong.exam）分表成功，magic.guangdong.exam库的Relation表，分表完成，检测无误后请手动清空Relation表中IsDeleted标记为1的记录，以加速当年的业务调用效率");
