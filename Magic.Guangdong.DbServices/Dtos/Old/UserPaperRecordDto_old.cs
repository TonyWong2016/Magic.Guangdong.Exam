...
{
    public class UserPaperRecordDto_ol2d
    {
        /// <summary>
        /// 抽题人ID
        /// </summary>
    ...
    public class MemberInfoDto_old
    {
    ...
    public class UserAnswerDto_old
    {
    ...
    /// 暂时用不到
    /// </summary>
    public class SubmitMyAnswerDto_old
    {
        public long recordId { get; set; }
    ...
    /// 作弊记录
    /// </summary>
    public class CheatDto_old
    {
        public long recordId { get; set; }
    }


    public class UserAnswerRecordDto_old
    {
    ...
    public class UserAnswerRecordMiniDto_old
    {
        public long recordId { get; set; }
